    ...
    <div className="addguestcontainer4">
      ...
      <div id="societynamesection">
        ...
        <div class="maintenancelist">
          ...
          <a href="/addrfid" class="AAddmaintenancelink"><b>Add RFID</b></a>
        </div>
        ...
        {/* <Loader loading={loading}> */}
          <Form className='formclass'>
            <div class="form-group  form-group5 row">
              ...
              <div class="col-lg-4">
                <select class="form-control input-lg input-lg1 AEN_border" id="blockid" name="Type" type="text" >
            ...
            <div class="form-group  form-group5 row">
              ...
              <div class="col-lg-4">
                <select class="form-control input-lg input-lg1 AEN_border" id="flatid" name="Type" type="text" >
            ...
            <div class="form-group form-group5 row">
              ...
              <div class="col-lg-4">
                <input type="number" id="amount" name="amount" className="form-control input-lg input-lg1 AEN_border" placeholder="Enter RFID"></input>
              </div>
            </div>
          
          
            <button type="submit" className="AMM_Add_btn" >Add RFID</button>
          </Form>
        {/* </Loader> */}
