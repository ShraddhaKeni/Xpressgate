        ...
        <Loader loading={loading}>
          ...
          <Form className='aeaclass'>
            <div class="form-group row">
              <label for="inputentryno" class="col-sm-2 col-md-2 col-lg-3 col-form-label ADN_label">Name</label>
            ...
            <div class="form-group row">
              <label class="col-lg-3 col-form-label ADN_label">Rule for Booking</label>
              <div class="col-lg-4">
            ...
            <div class="form-group row">
              <label class="col-lg-3 col-form-label ADN_label">Status</label>
              <div class="col-lg-4">
            ...
            <div class="form-group row">
              <label class="col-lg-3 col-form-label ADN_label">Rent</label>
              <div class="col-lg-4">
            ...
            <div class="form-group row">
              <label class="col-lg-3 col-form-label ADN_label">Image</label>
              <div class="col-lg-4">
