      ...
      <div>
        ...
        <div>
          <Form className='fcadmin'>
            ...
            <SimpleDropDownComponent items={[{ id: 1, option: 'Paid' }, { id: 0, option: 'Not Paid' }]} label={'Payment Status'} name={'payment_status'} id={'payment_status'}  onChange={(e) => { setCommission({ ...commission, payment_status: e.target.value }) }}  />
